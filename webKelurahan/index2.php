                ...
                <div class="collapse navbar-collapse fs-6" id="navbarNav">
                    <ul class="navbar-nav ms-auto" >
                        <li class="nav-item mx-1">
                            <a class="nav-link active" aria-current="page" href="index2.php?p=home">Home</a>
                        </li>

                        <li class="nav-item mx-1">
                            <a class="nav-link active" href="index2.php?p=datawarga">Data Warga</a>
                        </li>

                        <li class="nav-item mx-1">
                            <a class="nav-link active" href="index2.php?p=datapotensi">Data Potensi Wilayah</a>
                        </li>

                        <li class="nav-item mx-1">
                            <a class="nav-link active" href="index2.php?p=administratif">Data Administratif</a>
                        </li>
                    </ul>
                    <a href="login.php" ><button type="submit" class="btn btn-light btn-sm" style="color : #30968a; font-weight: bold;">Login Admin</button></a>
